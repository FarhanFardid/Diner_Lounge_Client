...
const MyCart = () => {
    ...
    return (
        ...
        <title>Bistro Boss | My Cart</title>
            ...
            <div className="grid grid-cols-3 gap-3 p-3 w-full items-center justify-center">
                <h2 className="text-2xl font-medium w-full text-center">Total orders: {cart.length}</h2>
  ...
  <table className="table mx-auto w-full m-5">
   ...
   {
    cart.map((item,index)=><CartItem key={item._id} item={item} index={index} refetch={refetch}></CartItem>)
   }
